...
public class Ex03_Main {
		...
		public static void main(String[] args) {
			...
			// 값변경, 넣어주는 방법 : 기본생성자로 만들어서 setter()
			Ex03 p1 = new Ex03();
			p1.setName("둘리");
			p1.setAge(24);
			p1.setWeight(105.4);
			
			// 값변경, 넣어주는 방법 :  인자가 있는 생성자에 값을 넣어준다.
			Ex03 p2 = new Ex03("희동이", 3, 40.5);
			Ex03 p3 = new Ex03("마이클", 23, 55.5);
			...
			// 크기 구하기
				...
				set1.clear();
				System.out.println("모두 삭제후 크기는? " + set1.size());
				
				boolean result = set1.isEmpty();
				if (result) {
					System.out.println("비어써");
				}else {
