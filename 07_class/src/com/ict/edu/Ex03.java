...
public class Ex03 {
		public static void main(String[] args) {
			...
			// 5. ceil(double x), round(double x) 반올림, floor(double x) 버림
			...
			// 6. max(자료형 a, 자료형 b) : 둘중 큰 값 출력
			// 7. min(자료형 a, 자료형 b) : 둘중 작은값 출력
			System.out.println("max : " + Math.max(44.6, 45));
			System.out.println("min : " + Math.min(44.6, 45));
			System.out.println("===============================================");
			
			
			// 8. pow(double a, double b) : 승
